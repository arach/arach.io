  ...
  experience: [
    {
      ...
      bullets: [
        ...
        "Building [Talkie](https://usetalkie.com) - native voice-to-action app launching Q1 2026",
        "Deep dive into AI-native development: LLMs, agentic coding workflows, and modern tooling",
        "Fractional tech leadership for friendly startups",
      ],
    ...
    },
    {
      ...
      funding: "$15M raised from Diagram, Real Ventures",
      exit: "Acquired by Zinnia",
      ...
      bullets: [
        ...
        "Scaled to ==10+ insurance carriers== choosing us for core modernization projects",
