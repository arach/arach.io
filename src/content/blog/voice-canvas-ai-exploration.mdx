...
thumbnailCrop:
  anchor: "bottom"  # Always show the bottom portion
...
I've been deep in exploration mode with voice-first interfaces and local model usage. The centerpiece of this exploration is [Openscout](https://github.com/arach/openscout), a transcription app I'm building as the foundation for something larger: what I'm calling a "voice canvas."
...
<MidjourneyPrompt 
  client:visible
  prompt="Photoreal minimal setup; soft gradient background; adult white man in slight profile speaking on his wired apple earphones - shows a simple waveform icon and a subtle action list --chaos 20 --raw --sref 3547226477 --stylize 850 --weird 500"
  imageUrl="https://cdn.midjourney.com/a59aba27-2184-4e2e-9443-293d11f3ba1b/0_0.png"
  midjourneyUrl="https://cdn.midjourney.com/a59aba27-2184-4e2e-9443-293d11f3ba1b/0_0.png"
/>
...
[Openscout](https://openscout.app) is currently a transcription tool, but I'm building it as the foundation for a canvas: a set of apps that work together. The iOS component will be empowered to do voice recordings (think Voice Memos app, but connected) and take asynchronous actions based on what you say.
