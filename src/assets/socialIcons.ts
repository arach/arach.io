const socialIcons = {
  ...
  >
    ...
    <path
      d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5" stroke-width="1.25"
    ></path>
  </svg>`,
  Facebook: `<svg
    xmlns="http://www.w3.org/2000/svg"
  ...
  Instagram: `<svg
    ...
    stroke-linejoin="round"
  >
    <path stroke="none" d="M0 0h24v24H0z" fill="none" stroke-width="1.25"></path>
    <rect x="4" y="4" width="16" height="16" rx="4" stroke-width="1.25"></rect>
    <circle cx="12" cy="12" r="3" stroke-width="1.25"></circle>
    <line x1="16.5" y1="7.5" x2="16.5" y2="7.501" stroke-width="1.25"></line>
  </svg>`,
  LinkedIn: `<svg
    xmlns="http://www.w3.org/2000/svg"
    class="icon-tabler"
  ...
  >
    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    <rect x="4" y="4" width="16" height="16" rx="2" stroke-width="1.25"></rect>
    <line x1="8" y1="11" x2="8" y2="16" stroke-width="1.25"></line>
    <line x1="8" y1="8" x2="8" y2="8.01" stroke-width="1.25"></line>
    <line x1="12" y1="16" x2="12" y2="11" stroke-width="1.25"></line>
    <path d="M16 16v-3a2 2 0 0 0 -4 0" stroke-width="1.25"></path>
  </svg>`,
  Mail: `<svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon-tabler"
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" stroke-width="1.25"></path>
      <rect x="3" y="5" width="18" height="14" rx="2" stroke-width="1.25"></rect>
      <polyline points="3 7 12 13 21 7" stroke-width="1.25"></polyline>
    </svg>`,
  Twitter: `<svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon-tabler"
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
      <path d="M22 4.01c-1 .49 -1.98 .689 -3 .99c-1.121 -1.265 -2.783 -1.335 -4.38 -.737s-2.643 2.06 -2.62 3.737v1c-3.245 .083 -6.135 -1.395 -8 -4c0 0 -4.182 7.433 4 11c-1.872 1.247 -3.739 2.088 -6 2c3.308 1.803 6.913 2.423 10.034 1.517c3.58 -1.04 6.522 -3.723 7.651 -7.742a13.84 13.84 0 0 0 .497 -3.753c-.002 -.249 1.51 -2.772 1.818 -4.013z" stroke-width="1.25"></path>
    </svg>`,
  Twitch: `<svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon-tabler"
  ...
  YouTube: `<svg
      ...
      stroke-linejoin="round"
    >
      <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z" stroke-width="1.25"></path>
      <polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02" stroke-width="1.25"></polygon>
    </svg>`,
  WhatsApp: `<svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon-tabler"
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" stroke-width="1.25"></path>
      <path d="M3 21l1.65 -3.8a9 9 0 1 1 3.4 2.9l-5.05 .9" stroke-width="1.25"></path>
      <path d="M9 10a0.5 .5 0 0 0 1 0v-1a0.5 .5 0 0 0 -1 0v1a5 5 0 0 0 5 5h1a0.5 .5 0 0 0 0 -1h-1a0.5 .5 0 0 0 0 1" stroke-width="1.25"></path>
    </svg>`,
  Snapchat: `<svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon-tabler"
  ...
  RSS: `<svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      fill="currentColor" // Add fill property to make it monochrome
      width="24" // Set the width to match the other social icons
      height="24" // Set the height to match the other social icons
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
      <path d="M4 11a9 9 0 0 1 9 9" stroke-width="1.25"></path>
      <path d="M4 4a16 16 0 0 1 16 16" stroke-width="1.25"></path>
      <circle cx="5" cy="19" r="1" stroke-width="1.25"></circle>
    </svg>`,
};
